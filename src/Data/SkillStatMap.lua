...
["nightblade_elusive_grants_critical_strike_multiplier_+_to_supported_skills"] = {
	flag("ElusiveCritMultiplier"),
	mod("ElusiveCritMultiplier", "BASE", nil, 0, 0, { type = "Condition", var = "Elusive" }, { type = "Condition", varList = { "UsingClaw", "UsingDagger" } }, { type = "Condition", varList = { "UsingSword", "UsingAxe", "UsingMace" }, neg = true}, { type = "GlobalEffect", effectType = "Buff" } ),
},
...
["supported_elemental_skill_gem_level_+"] = {
	mod("SupportedGemProperty", "LIST", { keyword = "active_skill", key = "level", value = nil }, 0, 0, { type = "SkillType", skillType = SkillType.Elemental }),
},
--Minion
